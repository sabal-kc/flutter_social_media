    ...
    case CreatePostRoute:
      ...
      return MaterialPageRoute(
          builder: (context) => CreatePostPage(
                displayImageUrl: arguments,
              ));
    case ExpandPostRoute:
      Map arguments = settings.arguments;
      return MaterialPageRoute(
          builder: (context) => ExpandPostPage(
                postID: arguments['id'],
                isLiked: arguments['isLiked'],
                userID: arguments["userID"],
                isDeletable: arguments['isDeletable'],
                mainUserID: arguments['mainUserID'],
              ));
    case CreateProfileRoute:
      Map arguments = settings.arguments;
      return MaterialPageRoute(
          builder: (context) => CreateEditProfile(
              user: arguments["user"], profile: arguments["profile"]));
    default:
      return MaterialPageRoute(builder: (context) => HomePage());
  }
}
